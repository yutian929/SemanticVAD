# -------------------------------------------------------------------------------------------------------------------------------------
# Acknowledgment: modified from Bio-Diffusion (https://github.com/BioinfoMachineLearning/bio-diffusion)
# -------------------------------------------------------------------------------------------------------------------------------------
...
class EMAModelCheckpoint(ModelCheckpoint):
    ...
    def _update_best_and_save(
        ...
        if del_filepath and self._should_remove_checkpoint(
            trainer, del_filepath, filepath
        ):
